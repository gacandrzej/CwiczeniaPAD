...
1. ![image3](media/image3.png)
    ...
    danych.
2. Zadanie 4: Skopiować wybrany obrazek \*.png lub inny z pomocą
    FileInputStream /FileOutputStream,
>
1. ![image4](media/image4.png)
